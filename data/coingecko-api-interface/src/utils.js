...
export function coingeckoChainDecode(_chainID) {
    ...
    switch (Number(_chainID)) {
        ...
        case 10: name = "optimistic-ethereum"; break;
        case 25: name = "cronos"; break;
        case 56: name = "binance-smart-chain"; break;
        case 100: name = "xdai"; break;
        case 137: name = "polygon-pos"; break;
        ...
        case 42161: name = "arbitrum-one"; break;
